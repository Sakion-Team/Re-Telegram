...
public class Nekogram {
    ...
    static {
        ...
        classList.add(new ClassInfo("org.telegram.messenger.AndroidUtilities", "y7"));
        ...
        methodList.add(new MethodInfo("ChatMessageCell", "measureTime", "d5"));
        ...
        methodList.add(new MethodInfo("ChatActivity", "addSponsoredMessages", "rg"));
        methodList.add(new MethodInfo("ChatActivity", "hasSelectedNoforwardsMessage", "oi"));
