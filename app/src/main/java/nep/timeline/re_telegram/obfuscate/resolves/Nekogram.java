...
public class Nekogram {
    ...
    static {
        ...
        classList.add(new ClassInfo("org.telegram.messenger.MessagesController", "Ys0"));
        classList.add(new ClassInfo("org.telegram.messenger.MessagesStorage", "gu0"));
        classList.add(new ClassInfo("org.telegram.messenger.MessageObject", "yq0"));
        classList.add(new ClassInfo("org.telegram.messenger.UserConfig", "Vk1"));
        ...
        classList.add(new ClassInfo("org.telegram.ui.ActionBar.Theme", "Yd1"));
        ...
        methodList.add(new MethodInfo("ChatActivity", "hasSelectedNoforwardsMessage", "Uh"));
