...
public class Nekogram {
    ...
    static {
        classList.add(new ClassInfo("org.telegram.messenger.ApplicationLoader", "F8"));
        classList.add(new ClassInfo("org.telegram.messenger.NotificationsController", "DB0"));
        classList.add(new ClassInfo("org.telegram.messenger.NotificationCenter", "dA0"));
        classList.add(new ClassInfo("org.telegram.messenger.MessagesController", "kv0"));
        classList.add(new ClassInfo("org.telegram.messenger.MessagesStorage", "rw0"));
        classList.add(new ClassInfo("org.telegram.messenger.MessageObject", "Js0"));
        classList.add(new ClassInfo("org.telegram.messenger.UserConfig", "Xn1"));
        classList.add(new ClassInfo("org.telegram.ui.Cells.ChatMessageCell", "org.telegram.ui.Cells.r"));
        classList.add(new ClassInfo("org.telegram.ui.ActionBar.Theme", "Zg1"));
        classList.add(new ClassInfo("org.telegram.ui.ChatActivity", "org.telegram.ui.f3"));
        classList.add(new ClassInfo("org.telegram.ui.DialogsActivity", "org.telegram.ui.f4"));
        classList.add(new ClassInfo("org.telegram.ui.FiltersSetupActivity$TouchHelperCallback", "org.telegram.ui.s1"));
        classList.add(new ClassInfo("org.telegram.messenger.AndroidUtilities", "i7"));
        ...
        methodList.add(new MethodInfo("ChatMessageCell", "measureTime", "U4"));
        ...
        methodList.add(new MethodInfo("ChatActivity", "addSponsoredMessages", "jg"));
        methodList.add(new MethodInfo("ChatActivity", "hasSelectedNoforwardsMessage", "ci"));
