...
public class Nekogram {
    ...
    static {
        ...
        classList.add(new ClassInfo("org.telegram.ui.FiltersSetupActivity", "org.telegram.ui.P4"));
        ...
        methodList.add(new MethodInfo("FiltersSetupActivity", "onDefaultTabMoved", "A2"));
