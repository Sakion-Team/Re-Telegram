...
public class Nekogram {
    ...
    static {
        classList.add(new ClassInfo("org.telegram.messenger.ApplicationLoader", "V8"));
        classList.add(new ClassInfo("org.telegram.messenger.NotificationsController", "NG0"));
        classList.add(new ClassInfo("org.telegram.messenger.NotificationCenter", "lF0"));
        classList.add(new ClassInfo("org.telegram.messenger.MessagesController", "iA0"));
        classList.add(new ClassInfo("org.telegram.messenger.MessagesStorage", "pB0"));
        classList.add(new ClassInfo("org.telegram.messenger.MessageObject", "Fx0"));
        classList.add(new ClassInfo("org.telegram.messenger.UserConfig", "Sv1"));
        classList.add(new ClassInfo("org.telegram.ui.Cells.ChatMessageCell", "org.telegram.ui.Cells.r"));
        classList.add(new ClassInfo("org.telegram.ui.ActionBar.Theme", "xo1"));
        classList.add(new ClassInfo("org.telegram.ui.ChatActivity", "org.telegram.ui.g3"));
        classList.add(new ClassInfo("org.telegram.ui.DialogsActivity", "org.telegram.ui.i4"));
        classList.add(new ClassInfo("org.telegram.ui.FiltersSetupActivity$TouchHelperCallback", "org.telegram.ui.s1"));
        classList.add(new ClassInfo("org.telegram.messenger.AndroidUtilities", "E7"));
        ...
        methodList.add(new MethodInfo("MessageObject", "updateMessageText", "L3"));
        methodList.add(new MethodInfo("MessageObject", "canForwardMessage", "r"));
        methodList.add(new MethodInfo("MessagesController", "isChatNoForwards", "p1"));
        methodList.add(new MethodInfo("MessagesController", "markDialogMessageAsDeleted", "U1"));
        methodList.add(new MethodInfo("MessagesController", "deleteMessages", "R"));
        methodList.add(new MethodInfo("MessagesController", "getInstance", "L0"));
        ...
        methodList.add(new MethodInfo("ChatActivity", "addSponsoredMessages", "ig"));
        methodList.add(new MethodInfo("ChatActivity", "hasSelectedNoforwardsMessage", "ai"));
